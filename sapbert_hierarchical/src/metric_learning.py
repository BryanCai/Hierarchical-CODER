...
class Sap_Metric_Learning(nn.Module):
    ...
    @autocast() 
    def get_umls_ms_loss(self, query_toks1, query_toks2, labels, sim):
        """
    ...
    @autocast() 
    def get_tree_ms_loss(self, query_toks1, query_toks2, dists, sim):
        """
        query : (N, h), candidates : (N, topk, h)
    ...
    @autocast() 
    def get_umls_clogit_loss(self, query_toks1, query_toks2, labels, sim):
        """
        query : (N, h), candidates : (N, topk, h)
    ...
    @autocast() 
    def get_tree_clogit_loss(self, query_toks1, query_toks2, dists, sim):
        """
        query : (N, h), candidates : (N, topk, h)
