...
import torch
from loss import AMSoftmax, HierarchicalMultiSimilarityLoss, HierarchicalTreeLogLoss, HierarchicalTreeLoss, TreeMultiSimilarityLoss
...
class UMLSPretrainedModel(nn.Module):
    def __init__(self, device, model_name_or_path,
        ...
        # self.tree_dist_embedding.weight = nn.Parameter(torch.tensor([[1.0], [0.0], [0.0], [0.0]]))
        ...
        self.tree_loss = TreeMultiSimilarityLoss(alpha=2, beta=2)
